<template>
  <div class="h-full flex flex-col">
    ...
    <div class="p-6">
      ...
      <div v-if="loading" class="bg-white shadow-md rounded-lg p-6 mb-6 flex justify-center my-8">
        <div role="status">
          <svg
            aria-hidden="true"
      ...
      <div v-else-if="transaction" class="bg-white shadow-md rounded-lg p-6 mb-6">
